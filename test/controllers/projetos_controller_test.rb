...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { descricao: @projeto.descricao, link: @projeto.link, titulo: @projeto.titulo, username_id: @projeto.username_id } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { descricao: @projeto.descricao, link: @projeto.link, titulo: @projeto.titulo, username_id: @projeto.username_id } }
